                ...
                <main className="flex items-center justify-center px-8 py-8 sm:px-12 lg:col-span-7 lg:px-16 lg:py-12 xl:col-span-6">
                    <div className="max-w-xl lg:max-w-3xl">
                        ...
                        <div className="mb-8">
                            ...
                            <div className="grid gap-6 grid-cols-1 md:items-center ">
                                <Link to ="/RegisterForUser">
                                <button type="submit" className="w-full inline-block shrink-0 rounded-md border border-black bg-black px-12 py-3 text-lg font-medium text-white transition hover:bg-transparent hover:text-black focus:outline-none focus:ring active:text-blue-500 dark:inline-block shrink-0 rounded-md border dark:border-white dark:bg-white px-12 py-3 text-sm font-medium dark:text-black transition dark:hover:bg-transparent dark:hover:text-white focus:outline-none focus:ring active:text-blue-500">
                                    สำหรับผู้ใช้งานทั่วไป
                                </button>
                                </Link>
                                <Link to ="/RegisterForPhoto">
                                <button type="submit" className="w-full inline-block shrink-0 rounded-md border border-black bg-black px-12 py-3 text-lg font-medium text-white transition hover:bg-transparent hover:text-black focus:outline-none focus:ring active:text-blue-500 dark:inline-block shrink-0 rounded-md border dark:border-white dark:bg-white px-12 py-3 text-sm font-medium dark:text-black transition dark:hover:bg-transparent dark:hover:text-white focus:outline-none focus:ring active:text-blue-500">
                                    สำหรับช่างภาพ
                                </button>
                                </Link>
                                <Link to ="/RegisterForRent">
                                <button type="submit" className="w-full inline-block shrink-0 rounded-md border border-black bg-black px-12 py-3 text-lg font-medium text-white transition hover:bg-transparent hover:text-black focus:outline-none focus:ring active:text-blue-500 dark:inline-block shrink-0 rounded-md border dark:border-white dark:bg-white px-12 py-3 text-sm font-medium dark:text-black transition dark:hover:bg-transparent dark:hover:text-white focus:outline-none focus:ring active:text-blue-500">
                                    สำหรับผู้ให้เช่าอุปกรณ์
                                </button>
                                </Link>
                            </div>
                    </div>
